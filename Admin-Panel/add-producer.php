...
<div class="content-header">
	<div class="container-fluid">
	  <div class="row mb-2">
	    <div class="col-sm-6">
	      <h1 class="m-0 text-dark">ADD PRODUCER</h1>
	    </div>
	  </div>
	</div>
</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="name" id="name" class="form-control" placeholder="Producer Name">
					</div>
				</div>
...
<script>
	...
	$("#submit").click(function(){
		...
		formData.append('action', 'add-producer');
		...
		$.ajax({
			...
			success: function(response){
						...
						if(response.dat == 1){
							...
							$("#add-producers").click();
						}else{ alert("Error adding producer.");}
					}
		});
	});

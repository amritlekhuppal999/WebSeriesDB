...
<div class="content-header">
	<div class="container-fluid">
	  <div class="row mb-2">
	    <div class="col-sm-6">
	      <h1 class="m-0 text-dark">ADD ACTORS</h1>
	    </div>
	  </div>
	</div>
</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="name" id="name" class="form-control" placeholder="Actor Name">
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="birth_name" id="birth_name" class="form-control" placeholder="Birth Name">
					</div>
				</div>
...
<script>
	...
	$("#submit").click(function(){
		...
		formData.append('action','add-actors');
